...
import homeBg from '@/static/images/home-bg.jpg'
import homeImg from '@/static/images/home-img.jpg'
...
var config={
		...
		stepList: [
			{
			    ...
			    step: [
					{title: ['第一步:点击“我的”', '第二步:点击“配送设置”'], img: bg},
	...
	compute: {
		...
		input: '输入',
		output: '输出',
		perCapitaPriceTitle: '外卖APP商家展示人均价格',
		unit: '单位(元)',
		perCapitaPrice: '人均价格',
